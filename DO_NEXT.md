...
pause/resume, R revive, and the all-left paused-game journey. An empty-party
pause resumes on the first rejoin so the returned player can immediately send
