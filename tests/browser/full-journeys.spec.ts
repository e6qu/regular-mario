...
// (The mobile NES control deck — that it sits below the canvas and drives the
// game — is covered comprehensively in touch.spec.ts, alongside the portrait
// rotate prompt and the desktop no-controls case.)
